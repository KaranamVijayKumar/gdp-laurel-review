<?php
/**
 * File: SubscriptionCreatedEvent.php
 * Created: 24-03-2015
 *
 * Description
 *
...
class SubscriptionCreatedEvent extends AbstractEventHandler
{
    /**
    ...
    public function __construct()
    {
        ...
        $this->template = Template::one(array('type' => 'subscription', 'name' => 'created',));
    }
