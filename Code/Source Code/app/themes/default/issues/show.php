...
<div class="media media--responsive">
    ...
    <div class="media__body">
        ...
        <?php echo $engine->getSection('issue-before TOC'); ?>

        <?php include __DIR__ .'/toc.partial.php' ?>

        <?php echo $engine->getSection('issue-after TOC'); ?>
        <hr/>
        <p>
            <?php
            echo \Story\HTML::link(
...
$breadcrumbs = array(
    ...
    \Story\HTML::link(action('\Project\Controllers\Issues\Index', array($issue->slug)), $title)
);
