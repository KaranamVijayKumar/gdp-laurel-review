...
<?php if (!count($items)) { ?>
    <div id="results">
        <p class="mb-"><em><?php echo _('There are no news articles.') ?></em></p>
    </div>
<?php } else { ?>
    <?php require __DIR__ . '/_partials/items.php' ?>
<?php } ?>
<?php
    ...
    <div class="flag flag--small flag--responsive ">
        ...
        <div class="flag__body">
            ...
            <input type="text" value="<?php echo $query ?>" class="actions__search text-input"
                   ...
                   data-url="<?php echo to(action('\Project\Controllers\Admin\News\Index')) ?>"
                    id="instant-search"/>
        </div>
    </div>
<?php
