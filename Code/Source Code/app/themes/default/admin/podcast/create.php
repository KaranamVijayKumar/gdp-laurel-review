    ...
    <div class="layout ph-- pt mb">
        <div class="layout__item 2/3 palm-1/1">
            ...
            echo \Story\Form::text(
                'slug',
                '',
                array('class' => 'text-input 1/1', 'id' => 'slug', 'placeholder' => _('My Podcast'))
            ) ?>
        </div><!--
     --><div class="layout__item 1/3 palm-1/1">
        ...
        <div class="layout__item 1/1 palm-1/1">
            ...
            <?php echo \Story\Form::file('audio_file', array('id' => 'file','required'=>'required')) ?>
            <p class="gray">
                <small>
        ...
        <div class="layout__item pt-">
            ...
            echo \Story\Form::textarea(
                ...
                array(
                    ...
                    'id'                      => 'guidelines',
                    'placeholder'             => _('Insert Podcast content here ...')
                )
            ) ?>
