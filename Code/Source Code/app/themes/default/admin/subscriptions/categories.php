...
ob_start();
if (!count($items)) { ?>
    <p class="mb-"><em><?php echo _('There are no categories.') ?></em></p>
<?php } else { ?>
    <?php require __DIR__ . '/category_items.partial.php' ?>
<?php } ?>
<?php
        ...
        <div class="flag flag--small flag--responsive ">
            <div class="flag__img mb0">
                <ul class="nav mv-- actions">
                    <li>
                        <?php
                        echo HTML::link(
                            action('\Project\Controllers\Admin\Subscriptions\Categories@create'),
                            _('New'),
                            array('class' => 'i-edit 1/1', 'title' => _('New category'))
                        ) ?>
                    </li>
            ...
            <div class="flag__body">
                ...
                <input type="text" value="<?php echo $query ?>" class="actions__search text-input"
                    ...
                    data-url="<?php echo to(action('\Project\Controllers\Admin\Subscriptions\Categories')) ?>"
                    id="instant-search"/>
            </div>
        </div>
    </div>
