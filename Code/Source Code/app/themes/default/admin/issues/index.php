...
if (!count($items)) { ?>
    <div id="results">
        <p class="mb-">
            <em><?php echo _('There are no issues.') ?></em>
        </p>
    </div>
<?php } else { ?>
        ...
        <div class="flag flag--small flag--responsive ">
            <div class="flag__img mb0">
                <ul class="nav mv-- actions">
                    <?php
                    if (has_access('admin_issues_create')) { ?>
                        <li>
                            <?php
                            echo HTML::link(
                        ...
                        <li> 
                            <?php
                            echo HTML::link(
                                action('\Project\Controllers\Admin\Issues\CreateV1'),
                                _('NewIssueByFile'),
                                array('class' => 'i-edit')
                            ) ?>
                        </li>
            ...
            <div class="flag__body">
                ...
                <input type="text" value="<?php echo $query ?>" class="actions__search text-input"
                       ...
                       data-url="<?php echo to(action('\Project\Controllers\Admin\Issues\Index')) ?>"
                        id="instant-search"/>
            </div>
        </div>
    </div>
