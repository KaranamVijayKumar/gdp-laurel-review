...
ob_start();
?>
<?php echo Form::open(array('action'=>'uploadcsv.php','errors' => $errors, 'enctype' => 'multipart/form-data')) ?>
    <div class="layout ph-- mb">
     ...
     --><div class="layout__item 1/2 palm-1/1">
		...
		<div class="layout__item 1/2 palm-1/1">
            <h4 class="content-hero"><?php echo _('Upload created PDF-file') ?></h4>
            <?php echo Form::label('pdf_file', _('File')); ?>
            <?php echo Form::file('pdf_file', array('id' => 'pdf_file','required'=>'required')) ?>
			<p class="gray">
                <small>
                    <?php
                    printf(
