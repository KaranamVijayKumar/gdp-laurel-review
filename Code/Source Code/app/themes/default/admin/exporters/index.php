...
if (!count($items)) { ?>
    <div id="results">
        <p class="mb-"><em><?php echo _('There are no exporters.') ?></em></p>
    </div>
<?php } else { ?>
        ...
        <div class="flag flag--small flag--responsive ">
                ...
                <ul class="nav mv-- actions  1/1">
                    <li>
                        ...
                        echo HTML::link(
                            ...
                            _('New'),
                            array('class' => 'i-edit', 'title' => _('New exporter'))
                        ) ?>
                    </li>
            ...
            <div class="flag__body">
                ...
                <input type="text" value="<?php echo $query ?>" class="actions__search text-input"
                       ...
                       data-url="<?php echo to(action('\Project\Controllers\Admin\Exporters\Index')) ?>"
                       id="instant-search"/>
            </div>
        </div>
    </div>
