...
<?php } else { ?>
    <?php require __DIR__ . '/partials/category_items.php' ?>
<?php } ?>
<?php
        ...
        <div class="flag flag--small flag--responsive ">
            <div class="flag__img mb0">
                <ul class="nav mv-- actions">
                    <li>
                        <?php
                        echo HTML::link(
                            action('\Project\Controllers\Admin\Submissions\Categories@create'),
                            _('New'),
            ...
            <div class="flag__body">
                ...
                <input type="text" value="<?php echo $query ?>" class="actions__search text-input"
                    ...
                    data-url="<?php echo to(action('\Project\Controllers\Admin\Submissions\Categories')) ?>"
                    id="instant-search"/>
            </div>
        </div>
    </div>
