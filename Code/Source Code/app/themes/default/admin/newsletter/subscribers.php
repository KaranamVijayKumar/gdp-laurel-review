...
?>
<?php if (!count($items)) { ?>
    <p class="mb-"><em><?php echo _('There are no newsletter subscribers.') ?></em></p>
<?php } else { ?>
    <?php require __DIR__ . '/subscribers.items.partial.php' ?>
<?php } ?>
<?php
    ...
    <div class="flag flag--small flag--responsive ">
        ...
        <div class="flag__body">
            ...
            <input type="text" value="<?php echo $query ?>" class="actions__search text-input"
                   ...
                   data-url="<?php echo to(action('\Project\Controllers\Admin\News\Subscribers')) ?>"
                   id="instant-search"/>
        </div>
    </div>
<?php
