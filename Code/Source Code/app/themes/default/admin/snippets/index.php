...
if (!count($items)) { ?>
    <div id="results">
        <p class="mb-"><em><?php echo _('There are no snippets.') ?></em></p>
    </div>
<?php } else { ?>
        ...
        <div class="flag flag--small flag--responsive ">
                ...
                <ul class="nav mv-- actions">
                    <li>
                        ...
                        echo HTML::link(
                            ...
                            _('New'),
                            array('class' => 'i-edit 1/1', 'title' => _('New snippet'))
                        ) ?>
                    </li>
            ...
            <div class="flag__body">
                ...
                <input type="text" value="<?php echo $query ?>" class="actions__search text-input"
                    ...
                    data-url="<?php echo to(action('\Project\Controllers\Admin\Pages\Snippets')) ?>"
                    id="instant-search"/>
            </div>
        </div>
    </div>
