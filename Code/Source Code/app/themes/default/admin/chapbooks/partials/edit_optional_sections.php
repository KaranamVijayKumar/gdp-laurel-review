...
if (count(\Project\Models\ChapbookContent::$optional_toc_sections)) {
    $optional_sections_links = \Project\Models\ChapbookContent::$optional_toc_sections;
    ...
    <?php foreach (\Project\Models\ChapbookContent::$optional_toc_sections as $key => $section) { $slug_section = slug($section); ?>
        <?php $content = $chapbook->contents->findBy('name', $section, $chapbook->default_content)->attributes['content'] ?>
