    ...
    <div class="layout ph-- mb">
     ...
     --><div class="layout__item 1/3 palm-1/1 mt">
        ...
        <div class="layout__item 1/2 palm-1/1">
            ...
            <p class="gray">
                <small>
                    <?php
                        echo _('Number of available chapbooks is required when the chapbook is enabled.')
                     ?>
                    <br/>
                    <?php
     ...
     --><div class="layout__item 1/2 palm-1/1">
            ...
            <p class="gray">
                <small>
                    ...
                    printf(
                        ...
                        '<strong>' . implode(', ', \Project\Models\ChapbookFile::$coverPageFileTypes) . '</strong>',
        ...
        <div class="layout__item pt-">
            ...
            <p class="mv0 gray">
                <small><?php echo _('The last uploaded and enabled chapbook is automatically set as the newest one.') ?>
                <?php echo _('After you create the chapbook, you will be able to add the table of contents also.') ?>
                </small>
            </p>
