...
<div class="media media--rev">
    ...
    <div class="media__body">
        <h4><?php echo _('Delete Chapbook') ?></h4>
        <p>
            <?php
            echo sprintf(
                _(
                    "This action will permanently remove the <q>%s</q> chapbook! ".
                    "This action is instant and cannot be recovered."
                ),
                '<strong>' . h($chapbook->title) . '</strong>'
            ) ?>
        </p>
    ...
    <div class="flag__body">
        <div class="flag flag--small flag--rev">
            <div class="flag__body gamma pv--">
                <?php echo HTML::link(action('\Project\Controllers\Admin\Chapbooks\Index'), _('Chapbooks')) ?>
                /
                <?php
                echo HTML::link(
                    action('\Project\Controllers\Admin\Chapbooks\Show', array($chapbook->id)),
